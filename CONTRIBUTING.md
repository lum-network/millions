...
1. You must provide a clear title and description of what you have implemented in your Pull Request.
2. When creating your Pull Request, our CI/CD process will test with basic data that the app runs without errors (not relying on testnet/mainnet data) and generate preview links based on the Cosmos Millions mainnet and testnet. 
3. You must ensure your Pull Request doesn't break anything inside the app with real data using these preview links.
