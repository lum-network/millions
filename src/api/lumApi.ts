...
class LumApi extends HttpClient {
    ...
    fetchPrizesByAddress = async (address: string, page = 0) => this.request<PrizeModel[]>({ url: `/millions/prizes/address/${address}?limit=100&page=${page}`, method: 'GET' }, PrizeModel);
